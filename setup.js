...
function addAnouncement() {
    ...
    */
    var mainAnnouncement = "Please update the following information as mush as you can, our professional sales will contact you to finalize the details in 1 business day!";
    var shippingMethodAnnouncement = "Select any shipping method for now and our customer service will contact you for shipping details within 24 hours!";
    var paymentMethodAnnouncement = "Select any shipping method for now and our customer service will contact you for payment details within 24 hours!";
...
function productDetailPageSetup() {
    ...
    productDetailPageTranslate();
}

function productDetailPageTranslate() {
    if (document.documentElement.lang == 'es') {
...
var onProductDetailPage = (location.pathname == "/ProductDetails.asp") ||
